/* Entity import for SOURCE-entities */
...
DEFINE package_name = 'STG_ORACLE_DEMO_SF';
DEFINE entity_physical_type = 'TABLE';
DEFINE entity_schema = 'staging';
DEFINE entity_type = 'STAGE';
...
meta_attributes as (
    /* Default metadata attributes defined for STAGE entity type.
       See documentation: https://docs.agiledataengine.com/docs/config_entity_defaults
       And examples: https://docs.agiledataengine.com/docs/customizing-default-attributes-and-transformations */
    SELECT
        'stg_batch_id' AS attribute_name,
        ...
        'Internal Attribute' as attribute_description,
        -5 as attribute_position
    FROM DUAL
    UNION ALL
    SELECT
        'stg_create_time' AS "attribute_name",
        'TIMESTAMP' as "attribute_datatype",
        null as "attribute_length",
        null as "attribute_precision",
        null as attribute_scale,
        1 as attribute_nullable,
        'SDT_STAGE_CREATE_TIME' as technical_attribute_type,
        'Internal Attribute' as attribute_description,
        -4 as attribute_position
    FROM DUAL
    UNION ALL
    SELECT
        'stg_source_system' AS "attribute_name",
        'VARCHAR' as "attribute_datatype",
        50 as "attribute_length",
        null as "attribute_precision",
        null as attribute_scale,
        1 as attribute_nullable,
        'SDT_STAGE_SOURCE' as technical_attribute_type,
        'Internal Attribute' as attribute_description,
        -3 as attribute_position
    FROM DUAL
    UNION ALL
    SELECT
        'stg_source_entity' AS "attribute_name",
        'VARCHAR' as "attribute_datatype",
        100 as "attribute_length",
        null as "attribute_precision",
        null as attribute_scale,
        1 as attribute_nullable,
        'SOURCE_ENTITY' as technical_attribute_type,
        'Staging source entity' as attribute_description,
        -2 as attribute_position
    FROM DUAL
    UNION ALL
    SELECT
        'stg_file_name' AS "attribute_name",
        'VARCHAR' as "attribute_datatype",
        100 as "attribute_length",
        null as "attribute_precision",
        null as attribute_scale,
        1 as attribute_nullable,
        'FILE_NAME' as technical_attribute_type,
        'Staging file name' as attribute_description,
